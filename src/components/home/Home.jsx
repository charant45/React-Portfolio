      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography variant="h2" sx={{ fontWeight: "bold", mb: 2, color: "#FD6F00", fontSize: "2.2rem" }}>
              Charan T
            </Typography>
            <motion.div
            ...
            <Typography
              variant="body1"
              sx={{ mb: 3, fontSize: { xs: "1rem", md: "1.25rem" }, maxWidth: { xs: "300px", md: "none" }, mx: "auto" }}
            >
              I specialize in designing seamless experiences for web applications as a web developer, focusing on
              user-friendly and aesthetically pleasing designs. My work involves collaborating with cross-functional
              teams to refine and implement effective design solutions.
            </Typography>
            <OrangeButton onClick={() => setShowForm(true)}>Hire Me</OrangeButton>
          </motion.div>
          ...
          >
            ...
            <Box sx={{ display: "flex", gap: 3 }}>
              <SocialIcon
                href="https://github.com/charant45"
                target="_blank"
              ...
              <SocialIcon
                href="https://www.linkedin.com/in/tcharan/"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.2 }}
                whileTap={{ scale: 0.9 }}
